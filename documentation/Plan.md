...
- ### Позитивные сценарии:
**1. Отправка формы с валидными данными, где указана карта со статусом "APPROVED"**
...
## API тесты ( POST запросы в БД)

1.POST запрос в БД с валидными данными через кнопку "Купить" и картой со статусом "APPROVED".

**ОР: Запись в БД с кодом ответа от сервера 200.**

2.POST запрос в БД с валидными данными через кнопку "Купить" и картой со статусом “DECLINED”.

**ОР: Запись в БД с кодом ответа от сервера 200.**

3.POST запрос в БД с валидными данными через кнопку "Купить в кредит" и картой со статусом "APPROVED".

**ОР: Запись в БД с кодом ответа от сервера 200.**

4.POST запрос в БД с валидными данными через кнопку "Купить в кредит" и картой со статусом “DECLINED”.
